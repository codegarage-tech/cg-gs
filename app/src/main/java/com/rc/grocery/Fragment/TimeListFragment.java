...
import com.rc.grocery.Adapter.TimeListAdapter;
...
import com.rc.grocery.util.RecyclerTouchListener;
...
public class TimeListFragment extends Fragment {
    ...
    private static String TAG = TimeListFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        currentDateValue = getArguments().getString("currentDateValue");
        ...
        rv_time.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), rv_time, new RecyclerTouchListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (currentDateValue.equalsIgnoreCase("0")) {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        TimeListAdapter adapter = new TimeListAdapter(time_list, currentDateValue);
