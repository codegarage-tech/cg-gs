...
import com.rc.grocery.Adapter.My_order_detail_adapter;
import com.rc.grocery.Config.BaseURL;
import com.rc.grocery.Model.My_order_detail_model;
...
public class MyOrderDetailFragment extends Fragment {
    ...
    private static String TAG = MyOrderDetailFragment.class.getSimpleName();
