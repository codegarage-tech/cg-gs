...
import com.rc.grocery.Adapter.Delivery_get_address_adapter;
import com.rc.grocery.Config.BaseURL;
import com.rc.grocery.Model.Delivery_address_model;
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.btn_deli_checkout) {
            ...
            if (TextUtils.isEmpty(getdate)) {
                ...
                Fragment fm = new TimeListFragment();
                args.putString("date", getdate);
                args.putString("currentDateValue", dateValue+"");
...
//            Toast.makeText(getActivity(), getResources().getString(R.string.current_date_mgs), Toast.LENGTH_SHORT).show();
//            cancel = true;
//        }else {
//            tv_date.setTextColor(getResources().getColor(R.color.color_white));
//            tv_time.setTextColor(getResources().getColor(R.color.color_white));
//        }
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        //RecyclerView.com.rc.grocery.Adapter adapter1 = new Delivery_get_address_adapter(delivery_address_modelList);
            ...
            if (type.contentEquals("update")) {
                ...
                Double total = Double.parseDouble(db_cart.getTotalAmount())+Integer.parseInt(deli_charges);
                 ...
                 if (Integer.parseInt(db_cart.getTotalAmount())>250){
                     tv_total.setText("" + db_cart.getTotalAmount()+" + "+"0" +" = "+Double.parseDouble(db_cart.getTotalAmount()));
                 } else {
