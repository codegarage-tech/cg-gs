...
public class SubCategoryFragment extends Fragment {
    ...
    private String selectedCategoryId = "", selectedCategoryTitle = "", selectedSubCategoryTitle = "";
    ...
    private List<Category_subcat_model> categorySubList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        selectedCategoryId = getArguments().getString("cat_id");
        selectedCategoryTitle = getArguments().getString("cat_title");
        selectedSubCategoryTitle = getArguments().getString("sub_cat_title");
//
        ((MainActivity) getActivity()).setTitle(selectedCategoryTitle);

        // check internet connection
        if (ConnectivityReceiver.isConnected()) {
            //setCategorySubList(getcat_id);
            makeGetCategoryRequest(selectedCategoryId);
        }
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        Log.e("category_modelList", category_modelList.toString() + ">>>");
                        ...
                        if (!category_modelList.isEmpty()) {
                            ...
                            for (int i = 0; i < category_modelList.size(); i++) {
                                ...
                                String subtitle = category_modelList.get(i).getTitle();
                                boolean isSelected = false;
                                if (subtitle.equalsIgnoreCase(selectedSubCategoryTitle)) {
                                    // Select selected tab
                                    isSelected = true;
                                }
                                tab_cat.addTab(tab_cat.newTab().setText(subtitle), isSelected);
                            }
                        } else {
