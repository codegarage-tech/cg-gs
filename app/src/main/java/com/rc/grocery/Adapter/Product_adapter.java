...
import com.rc.grocery.Fragment.ProductDetailFragment;
...
public class Product_adapter extends RecyclerView.Adapter<Product_adapter.MyViewHolder>
    ...
    private String TAG = Product_adapter.class.getSimpleName();
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (id == R.id.iv_subcat_plus) {
                ...
                AppUtil.setCartButtonBackground(context, tv_add, true);
                ...
                if (!tv_contetiy.getText().toString().equalsIgnoreCase("0")) {
                    ...
                    AppUtil.setCartButtonBackground(context, tv_add, false);
                } else {
...
//                        position, tv_contetiy.getText().toString());
                ...
                Product_model product_model = modelList.get(position);
                Log.d(TAG, product_model.toString());

                ProductDetailFragment productDetailFragment = new ProductDetailFragment();
                Bundle args = new Bundle();
                args.putString("title", modelList.get(position).getTitle());
                args.putParcelable("product_model", Parcels.wrap(product_model));
                productDetailFragment.setArguments(args);

                FragmentManager fragmentManager = ((Activity)context).getFragmentManager();
                fragmentManager.beginTransaction().replace(R.id.contentPanel, productDetailFragment)
    ...
    public void onBindViewHolder(Product_adapter.MyViewHolder holder, int position) {
        ...
        AppUtil.loadImage(context,holder.iv_logo, BaseURL.IMG_PRODUCT_URL + mList.getProduct_image(), false, true);
...
//                .into(holder.iv_logo);
        ...
        if (dbcart.isInCart(mList.getProduct_id())) {
            ...
            AppUtil.setCartButtonBackground(context, holder.tv_add, false);
        } else {
            holder.tv_add.setText(context.getResources().getString(R.string.tv_pro_add));
            AppUtil.setCartButtonBackground(context, holder.tv_add, true);
        }
    ...
    private void showImage(String image) {
        ...
        AppUtil.loadImage(context,iv_image, BaseURL.IMG_PRODUCT_URL +image, false, true);
