...
public class Cart_adapter extends RecyclerView.Adapter<Cart_adapter.ProductHolder> {
    ...
    public void onBindViewHolder(final ProductHolder holder, final int position) {
        ...
        AppUtil.loadImage(activity,holder.iv_logo, BaseURL.IMG_PRODUCT_URL + map.get("product_image"), false, true);
...
//                .into(holder.iv_logo);
        ...
        holder.iv_minus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AppUtil.setCartButtonBackground(activity, holder.tv_add, true);
            }
        });
        ...
        holder.tv_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AppUtil.setCartButtonBackground(activity, holder.tv_add, false);
            }
        });
    ...
    class ProductHolder extends RecyclerView.ViewHolder {
        ...
        public ProductHolder(View view) {
            ...
            AppUtil.setCartButtonBackground(activity, tv_add, false);
        }
    }
